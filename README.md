...
#### [Хакатон №2. IT Purple Hack](https://github.com/ArturArtikov/Portfolio/blob/main/README.md#хакатон-2-it-purple-hack-1) :white_check_mark:
...
Разработать и реализовать алгоритм, который будет разбивать информацию, содержащуюся в резюме кандидата по смысловым блокам: образование, опыт работы, навыки и т.д. На выходе должен быть структурированный JSON. Данные предоставляются в виде структурированных резюме кандидатов в произвольном виде (word, pdf…). Для создания алгоритма можно использовать языковые модели - LLM, а также создавать и обучать собственные модели машинного обучения. Ограничения на стек нет


#### План для достижения цели проекта

1. Получить более 200 резюме в форматах .pdf, .docx и .doc
2. Создать парсер для получения данных из резюме в .pdf с помошью PyPDF2
3. Создать парсер для получения данных из резюме в .docx с помошью DOCX
4. Создать исключение для работы с файлами в формате .doc
5. Собрать данные из всех резюме в один .csv файл
6. Написать функции, использующие регулярные выражения для получения базовой информации из резюме
7. Выделить в датафрейме с помощью регулярных выражений номера телефонов, имя, фамилию, электронную почту и должность соискателя
8. Использовать открытый исходный код модуля pyresparser для получения оставшихся данных
9. Произвести сортировку полученных из резюме данных
10. Составить обширный JSON-файл с результатами парсинга данных
11. Создать Docker-образ для полученной программы
12. Создать презентацию
13. Загрузить готовое решение и защитить проект 
...
* Руслан Кондрашук: Data Scientist | Product Manager | Капитан
...
Ссылка на весь проект целиком - [здесь](https://github.com/ArturArtikov/Portfolio/tree/main/4_case_championships_projects/case_1)
