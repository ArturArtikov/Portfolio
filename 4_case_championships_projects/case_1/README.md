...
_ Задача 1-го этапа:__ Согласовать подход к объединению двух банков с описанием бюджета, модели проектного управления и разработкой целевой архитектуры
